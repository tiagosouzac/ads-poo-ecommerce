...
public class CustomerRegister extends javax.swing.JFrame {
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (strName.isEmpty() || strEmail.isEmpty() || strPhone.isEmpty() || strStreet.isEmpty() || strNumber.isEmpty() ||
        ...
        Address existingAddress = addressController.getAddresses().stream()
            .filter(address -> address.getZipCode().equals(strZipCode))
            .findFirst()
            .orElse(null);
